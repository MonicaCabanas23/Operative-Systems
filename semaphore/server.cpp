...
//void readHandler(int, siginfo_t*, void*);
//void writeHandler(int, siginfo_t*, void*);
...
void readHandler(int signum, siginfo_t* info, void* context) {
...
void writeHandler(int signum, siginfo_t* info, void* context) {
...
int writeInMemory(string message) {
    try {
